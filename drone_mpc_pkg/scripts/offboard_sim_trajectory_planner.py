...
LastEditors: Wei Luo
LastEditTime: 2021-04-07 17:51:08
            ...
            if self.previous_trajectory is not None:
                ...
                if self.trajectory_method == 'poly':
                    for i in range(self.time_horizon):
                        ...
                        temp_.roll = 0.0
                        temp_.pitch = 0.0
                        quaternion_ = self.rpy_to_quaternion(np.array([0.0, 0.0, temp_.yaw]))
                    ...
                    quaternion_ = self.rpy_to_quaternion(np.array([temp_.roll, temp_.pitch, temp_.yaw]))
                    temp_.q[0] = quaternion_[0]
                    temp_.q[1] = quaternion_[1]
                    temp_.q[2] = quaternion_[2]
                    temp_.q[3] = quaternion_[3]
...
if __name__ == '__main__':
    ...
    # trajectory_index = rospy.get_param('~trajectory_index')

    trajectory_gen = TrajectoryGenerator(steps=time_horizon, method='poly') # index=trajectory_index,
